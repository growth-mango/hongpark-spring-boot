...
class CommentRepositoryTest {
    ...
    void findByArticleId() {
        ...
        /* Case 3 : 9번 게시글의 모든 댓글 조회 */
        {
            ...
            // 검증
            assertEquals(expected, comments, "9번 글은 존재하지 않음");
        }
        ...
        /* Case 4 : 9999번 게시글의 모든 댓글 조회 */
        {
            ...
            // 검증
            assertEquals(expected, comments, "999번 글은 존재하지 않음");
        }
        ...
        /* Case 5 : -1번 게시글의 모든 댓글 조회 */
        {
            ...
            // 검증
            assertEquals(expected, comments, "-1번 게시글은 존재하지 않음");
        }
    }
    ...
    void findByNickname() {
        ...
        /* Case 3 : null의 모든 댓글 조회*/
        {
            ...
            // 검증하기
            assertEquals(expected, comments, "null이 입력됨");
        }
        ...
        /* Case 4 : ""의 모든 댓글 조회*/
        {
            ...
            // 검증하기
            assertEquals(expected, comments, "빈 값이 입력됨");
        }
    }
}